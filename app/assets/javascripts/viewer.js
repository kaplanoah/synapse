...
(function() {
  var ColorMap, Crosshairs, DataField, DataPanel, Image, Layer, LayerList, Slider, Threshold, Transform, UserInterface, View, Viewer, _Viewer,
  ...
  _Viewer = (function() {
    ...
    _Viewer.prototype.addView = function(element, dim, index, labels) {
      ...
      return this.views.push(new View(this, element, dim, index, labels));
    };
    ...
    _Viewer.prototype.addAxisPositionField = function(name, element, dim) {
    ...
    _Viewer.prototype.addSignSelect = function(element) {
    ...
    _Viewer.prototype.loadImages = function(images, activate) {
      var ajaxReqs, data, img, typeIsArray, _i, _len,
        _this = this;
      if (activate == null) {
        activate = null;
      }
  ...
  Layer = (function() {
    ...
    function Layer(name, image, palette, sign) {
      this.name = name;
      this.image = image;
      if (palette == null) {
  ...
  View = (function() {
    ...
    function View(viewer, element, dim, labels, slider) {
      this.viewer = viewer;
    ...
    View.prototype.paint = function(layer) {
      var col, cols, data, dims, i, img, j, val, xCell, xp, yCell, yp, _i, _j, _ref, _ref1;
    ...
    View.prototype.drawCrosshairs = function(ch) {
      var xPos, yPos;
      if (ch.visible) {
    ...
    View.prototype._canvasClick = function(e) {
      ...
      cx = pt.x / this.width;
      cy = pt.y / this.height;
      return this.viewer.updatePosition(this.dim, cx, cy);
    };
